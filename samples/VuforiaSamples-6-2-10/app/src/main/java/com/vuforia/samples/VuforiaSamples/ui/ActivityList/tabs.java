...
public class tabs extends AppCompatActivity implements TabLayout.OnTabSelectedListener, frag2.onButtonClickListener {
    ...
    private void startImageRecoActivity()
    {
        ...
        mClassToLaunchPackage = getPackageName();
        mClassToLaunch = mClassToLaunchPackage + "." + "app.ImageTargets_1.ImageTargets_1";
        Intent i = new Intent();
        i.setClassName(mClassToLaunchPackage, mClassToLaunch);
        startActivity(i);
    }
