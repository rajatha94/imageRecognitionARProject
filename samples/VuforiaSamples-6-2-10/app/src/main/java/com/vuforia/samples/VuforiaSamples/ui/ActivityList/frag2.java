...
public class frag2 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mStartButton1 =(Button)v.findViewById(R.id.button_start);
        mStartButton1.setOnClickListener(this);

        mStartButton2 = (Button)v.findViewById(R.id.button_start1);
    ...
    public void onClick(View v){
        ...
        if (v == v.findViewById(R.id.button_start)) {
            try {
                ((onButtonClickListener) activity).onButtonClicked(v);
            } catch (ClassCastException cce) {

            }
        }
        else if(v == v.findViewById(R.id.button_start1))
        {
            try {
                ((onButtonClickListener) activity).onImageButtonClicked(v);
            }catch (ClassCastException cce){
